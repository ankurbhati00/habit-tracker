...
import { faAngleLeft, faAngleRight, faEllipsisVertical } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className={style.all_habits_container}>
        <div className={style.habit_container}>
                  ...
                  <div className={style.habit}>
                      ...
                      <span className={style.habit_info}>2&nbsp; <img  src={fire_png} />&nbsp; <FontAwesomeIcon icon={faEllipsisVertical} /> </span>
                  </div>
        </div>
        <div className={style.habit_container}>
                  <div className={style.colour_dot}></div>
